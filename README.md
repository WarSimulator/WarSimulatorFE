...
`DRAW > Tactical Tasks (전술 과업)`에서 MIL-STD-2525E 36개, NATO APP-6D 39개 도형을 선택합니다.
영어/한글 검색과 번호가 붙은 기준점 미리보기를 제공합니다. `Draw task`를 누른 뒤 지도에 순서대로 클릭합니다.
...
선·영역·전술 과업 도형을 더블클릭하면 위에 회전 핸들이 나타납니다.
